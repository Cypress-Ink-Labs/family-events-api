...
(topology + gate + failure pings); U28/U30 pure-logic ports landed; U29 review queue
worker + ReviewRepository landed; U28–U33 remaining.
...
### U29 — Classification + enrichment port 🟡 (review queue landed)
